        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              ŠN Gorišnica je srce naše lokalne skupnosti. Od leta 1946 združujemo generacije ljubiteljev nogometa, spodbujamo športni duh in gradimo prijateljstva, ki trajajo vse življenje.
            </p>
